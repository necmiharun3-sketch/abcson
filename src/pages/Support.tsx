    ...
    <div className="max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-[#1a1b23] p-5 rounded-xl border border-white/5 flex items-center gap-4">
          ...
          <div>
            <div className="text-2xl font-bold text-white">{tickets.filter(t => t.status === 'Cevaplandı' || status === 'pending_user').length}</div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500">
                          ...
                          <span className={`flex items-center gap-1 font-bold ${ticket.status === 'Cevaplandı' || status === 'pending_user' ? 'text-emerald-400' : 'text-amber-400'}`}>
                            <span className={`w-1.5 h-1.5 rounded-full ${ticket.status === 'Cevaplandı' || status === 'pending_user' ? 'bg-emerald-400' : 'bg-amber-400'}`} />
                            {ticket.status}
                          </span>
